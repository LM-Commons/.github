...
"prFooter": "[Read more information](https://github.com/lm-commoms/.github/blob/main/RENOVATE.md) about the use of [Renovate Bot](https://github.com/renovatebot/renovate) within Laminas.",
...
- **local>lm-commons/.github:renovate-config** - As stated, the first preset extends the default configuration described
above.
...
The Renovate config for LM-Commons originates from the [Laminas project](https://github.com/laminas/.github/blob/main/RENOVATE.md)
Renovate config.
